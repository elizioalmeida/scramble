...
def pdf_view(request):
    ...
    return FileResponse(open('controle/templates/reports/teste1.pdf', 'r'), content_type='application/pdf')
...
class principal:
	...
	outfile = open('/home/elizio/scramble/controle/templates/reports/relCP.tex', 'w')
	relCP("blunk")
	'''
	
	ver_arq = verificar_arquivo()
